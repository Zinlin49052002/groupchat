...
def reciever():
    while True:
        try:
            print(usernameG+" This is user!")
            print(toUsernameG+" This is other user!")
...
class HomeFrame(Frame):
    def __init__(self,parent,username,email,profile,client):
        ...
        user(self.f,self.welcome,self.rightFrame,"Group",self.opImgData,False).pack(side="top",anchor="w")
        self.welcome.grid(column=2,row=0,columnspan=4,rowspan=6)
